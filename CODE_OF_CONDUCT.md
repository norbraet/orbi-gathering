...
requests, and discussions in this repository), and also applies when an
individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the repository owner privately through their GitHub profile. All
...
1. **Correction** — A private, written warning for use of inappropriate
   language or unprofessional behavior, with clarity around the violation and
   an explanation of why the behavior was inappropriate.
2. **Warning** — A warning with consequences for continued behavior, and no
